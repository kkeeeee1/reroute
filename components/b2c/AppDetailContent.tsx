  ...
  return (
    <section>
      <div className="max-w-screen-max px-7 md:px-10 lg:px-20 py-16 md:py-20 lg:py-24 mx-auto grid grid-cols-1 md:grid-cols-[300px_1fr] xl:grid-cols-[400px_1fr] gap-12 md:gap-16 xl:gap-20">
        {/* 왼쪽: 썸네일 */}
        <div ref={thumbnailRef} className="relative aspect-[3/2] overflow-hidden bg-[#141B29] opacity-0" style={{ willChange: 'transform, opacity' }}>
        ...
        <div>
          <div className="mb-[18px] md:mb-[22px] lg:mb-[25px] xl:mb-[26px] 2xl:mb-[28px]">
            <div className="w-full flex justify-between items-center mb-[14px] md:mb-[17px] lg:mb-[19px] xl:mb-[20px] 2xl:mb-[21px]">
              {/* 앱 이름*/}
              <h1 ref={titleRef} className="text-[36px] md:text-[44px] lg:text-[50px] xl:text-[53px] 2xl:text-[56px] leading-[36px] md:leading-[42px] lg:leading-[45px] xl:leading-[46px] 2xl:leading-[48px] font-extrabold opacity-0" style={{ willChange: 'transform, opacity' }}>
                {app.name}
              </h1>
            ...
            {/* 앱 설명 */}
            <p ref={summaryRef} className="text-[18px] md:text-[22px] lg:text-[25px] xl:text-[26px] 2xl:text-[28px] leading-[28px] md:leading-[38px] lg:leading-[43px] xl:leading-[45px] 2xl:leading-[48px] font-medium mb-[24px] md:mb-[30px] lg:mb-[35px] xl:mb-[37px] 2xl:mb-[39px] opacity-0" style={{ willChange: 'transform, opacity' }}>
              {app.summary}
            </p>
            {/* 생성일 */}
            {formattedDate && (
              <p ref={dateRef} className="text-[14px] md:text-[16px] lg:text-[18px] xl:text-[19px] 2xl:text-[20px] leading-[28px] md:leading-[38px] lg:leading-[43px] xl:leading-[45px] 2xl:leading-[48px] font-medium text-[#999999] opacity-0" style={{ willChange: 'transform, opacity' }}>
                {formattedDate}
              </p>
            )}
          </div>
          ...
          {/* 이전글/다음글 버튼 */}
          <div ref={navRef} className="flex items-center justify-center gap-[12px] md:gap-[15px] lg:gap-[17px] xl:gap-[18px] 2xl:gap-[20px] opacity-0" style={{ willChange: 'transform, opacity' }}>
              {/* 이전글 버튼 */}
