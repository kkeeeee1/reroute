...
export function HeroSection() {
    ...
    return (
        <section ref={containerRef} id="b2b-hero-section" className="relative flex min-h-[70vh] md:min-h-[85vh] flex-col bg-black text-white overflow-hidden">
            ...
            <div className="relative z-10 mx-auto max-w-screen-max flex w-full flex-1 flex-col px-5 md:px-10 lg:px-16 xl:px-20 pt-32 pb-12 md:pt-48 xl:pt-56 2xl:pt-64 lg:pb-16">
