...
export function SolutionsSection() {
  const solutions = [
    {
      ...
      description:
        "CBO/CMO급 전략 파트너로 프로젝트 전반을 책임지며, 조직을 체계적으로 기업화합니다.",
      items: [
  ...
  return (
    <section
      ref={containerRef}
      id="b2b-solutions-section"
      className="relative bg-black text-white py-16 md:py-20 lg:py-24 xl:py-28 2xl:py-32 overflow-hidden"
    >
        ...
        <div className="flex flex-col md:flex-row gap-8 md:gap-12 xl:gap-14 2xl:gap-16">
          ...
          <div ref={leftSectionRef} className="hidden md:block md:w-[200px] lg:w-[240px] xl:w-[280px] flex-shrink-0">
            ...
            <div ref={verticalTextRef} className="mt-8 md:mt-10 xl:mt-12">
              <p
                className="whitespace-nowrap text-[14px] md:text-[16px] xl:text-[18px] tracking-widest text-[#666666] rotate-180"
