        ...
        <section ref={containerRef} id="case-study-section" className="bg-white overflow-hidden">
            <div className="mx-auto max-w-screen-max px-7 md:px-10 lg:px-16 xl:px-20 py-16 md:py-20 lg:py-24 xl:py-28 2xl:py-32">
                ...
                <div className="space-y-10 md:space-y-12 lg:space-y-14 xl:space-y-16 2xl:space-y-[70px]">
                    ...
                    {/* Problem */}
                    <div ref={problemRef} className="flex flex-col md:flex-row gap-6 md:gap-8 lg:gap-10 xl:gap-12">
                        ...
                        <p className="flex-1 text-[14px] md:text-[16px] lg:text-[20px] xl:text-[24px] 2xl:text-[28px] leading-[24px] md:leading-[28px] lg:leading-[36px] xl:leading-[44px] 2xl:leading-[50px]">
                            대형견 동반 한옥 카페'라는 명확한 비전이 있었지만, 인테리어 사기로 프로젝트가 전면 중단.
                            <br />
                    ...
                    {/* Reroute */}
                    <div ref={rerouteRef} className="flex flex-col md:flex-row gap-6 md:gap-8 lg:gap-10 xl:gap-12">
                        ...
                        <div className="flex-1 space-y-8 md:space-y-10 lg:space-y-12 xl:space-y-14 2xl:space-y-[60px]">
                            <p className="text-[14px] md:text-[16px] lg:text-[20px] xl:text-[24px] 2xl:text-[28px] leading-[24px] md:leading-[28px] lg:leading-[36px] xl:leading-[44px] 2xl:leading-[50px]">
                                리루트는 총괄 PM 파트너십을 체결하여 위기를 '브랜드 자산으로 전환'하는 전략으로 재설계했습니다.
                            </p>
                            <ul className="space-y-4 md:space-y-5 lg:space-y-6 xl:space-y-7 2xl:space-y-[26px] text-[14px] md:text-[16px] lg:text-[18px] xl:text-[20px] 2xl:text-[22px] leading-[22px] md:leading-[24px] lg:leading-[26px] xl:leading-[28px] 2xl:leading-[30px] ml-0">
                                <li className="flex items-center gap-2 md:gap-2.5 lg:gap-3 xl:gap-3.5 2xl:gap-[13px]">
                                    <span className="h-1.5 w-1.5 md:h-2 md:w-2 flex-shrink-0 rounded-full bg-primary"></span>
                                    <span ><strong>위기 전환</strong> : 셀프 인테리어 문제를 진정성 있는 브랜드 스토리로 반전</span>
                                </li>
                                <li className="flex items-center gap-2 md:gap-2.5 lg:gap-3 xl:gap-3.5 2xl:gap-[13px]">
                                    <span className="h-1.5 w-1.5 md:h-2 md:w-2 flex-shrink-0 rounded-full bg-primary"></span>
                                    <span ><strong>포지셔닝</strong> : 단순 카페 → '반려동물 커뮤니티'의 문화적 아지트</span>
                                </li>
                                <li className="flex items-center gap-2 md:gap-2.5 lg:gap-3 xl:gap-3.5 2xl:gap-[13px]">
                                    <span className="h-1.5 w-1.5 md:h-2 md:w-2 flex-shrink-0 rounded-full bg-primary"></span>
                    ...
                    {/* Solutions */}
                    <div ref={solutionsRef} className="flex flex-col md:flex-row gap-6 md:gap-8 lg:gap-10 xl:gap-12">
                        ...
                        <div className="flex-1 flex flex-col gap-8 md:gap-10 lg:gap-12 xl:gap-14 2xl:gap-[60px]">
                            ...
                            <div className="flex-1">
                                <div className='flex gap-2 md:gap-2.5 lg:gap-3 xl:gap-3.5 2xl:gap-[10px] items-end mb-6 md:mb-7 lg:mb-8 xl:mb-10 2xl:mb-[44px]'>
                                    <span className='text-[40px] md:text-[48px] lg:text-[56px] xl:text-[64px] 2xl:text-[70px] leading-[30px] md:leading-[36px] lg:leading-[42px] xl:leading-[46px] 2xl:leading-[50px] font-thin'>01</span>
                                ...
                                <h4 className="mb-8 md:mb-10 lg:mb-12 xl:mb-14 2xl:mb-[64px] text-[16px] md:text-[18px] lg:text-[20px] xl:text-[24px] 2xl:text-[28px] font-bold">브랜드 경험(BX) 설계</h4>
                                <ul className="space-y-4 md:space-y-5 lg:space-y-6 xl:space-y-7 2xl:space-y-[26px] text-[14px] md:text-[16px] lg:text-[18px] xl:text-[20px] 2xl:text-[22px] leading-[22px] md:leading-[24px] lg:leading-[26px] xl:leading-[28px] 2xl:leading-[30px] ml-0">
                                    <li className="flex items-center gap-2 md:gap-2.5 lg:gap-3 xl:gap-3.5 2xl:gap-[13px]">
                                        <span className="h-1.5 w-1.5 md:h-2 md:w-2 flex-shrink-0 rounded-full bg-primary"></span>
                            ...
                            <div className="flex-1">
                                <div className='flex gap-2 md:gap-2.5 lg:gap-3 xl:gap-3.5 2xl:gap-[10px] items-end mb-6 md:mb-7 lg:mb-8 xl:mb-10 2xl:mb-[44px]'>
                                    <span className='text-[40px] md:text-[48px] lg:text-[56px] xl:text-[64px] 2xl:text-[70px] leading-[30px] md:leading-[36px] lg:leading-[42px] xl:leading-[46px] 2xl:leading-[50px] font-thin'>02</span>
                                    <div className="h-[8px] w-[8px] md:h-[9px] md:w-[9px] lg:h-[10px] lg:w-[10px] xl:h-[11px] xl:w-[11px] 2xl:h-[12.5px] 2xl:w-[12.5px] rounded-full bg-primary"/>
                                </div>
                                <h4 className="mb-8 md:mb-10 lg:mb-12 xl:mb-14 2xl:mb-[64px] text-[16px] md:text-[18px] lg:text-[20px] xl:text-[24px] 2xl:text-[28px] font-bold">현장 운영 시스템 구축</h4>
                                <ul className="space-y-4 md:space-y-5 lg:space-y-6 xl:space-y-7 2xl:space-y-[26px] text-[14px] md:text-[16px] lg:text-[18px] xl:text-[20px] 2xl:text-[22px] leading-[22px] md:leading-[24px] lg:leading-[26px] xl:leading-[28px] 2xl:leading-[30px] ml-0">
                                    <li className="flex items-center gap-2 md:gap-2.5 lg:gap-3 xl:gap-3.5 2xl:gap-[13px]">
                                        <span className="h-1.5 w-1.5 md:h-2 md:w-2 flex-shrink-0 rounded-full bg-primary"></span>
                    ...
                    {/* Result */}
                    <div ref={resultRef} className="flex flex-col md:flex-row gap-6 md:gap-8 lg:gap-10 xl:gap-12">
...
const Border = () => {
    return (
        <div className="border-t border-[#B9B9B9] w-full" />
    );
}
...
const CaseStudyCategory = ({ title }: { title: string }) => {
    return (
        <div className="w-full md:w-[180px] xl:w-[220px] 2xl:w-[250px] flex-shrink-0">
            <h3 className="text-[24px] md:text-[28px] lg:text-[32px] xl:text-[36px] 2xl:text-[40px] leading-none font-bold">{title}</h3>
        </div>
    )
}