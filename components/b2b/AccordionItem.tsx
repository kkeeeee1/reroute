...
export function AccordionItem({
  ...
  return (
    <article
      ref={itemRef}
      className={`pb-8 md:pb-10 lg:pb-12 xl:pb-14 2xl:pb-[60px] flex flex-col gap-8 md:gap-10 lg:gap-12 xl:gap-14 2xl:gap-[70px] ${!isLast ? "border-b border-[#333333]" : ""} mb-10 md:mb-12 lg:mb-16 xl:mb-20 2xl:mb-[80px]`}
    >
      <div className="mb-2 md:mb-3 lg:mb-4 flex flex-col gap-4 md:gap-5 lg:gap-6 xl:gap-7 2xl:gap-[30px]">
        ...
        <h3
          ref={titleRef}
          className="text-[28px] md:text-[36px] lg:text-[44px] xl:text-[52px] 2xl:text-[60px] leading-[32px] md:leading-[40px] lg:leading-[48px] xl:leading-[56px] 2xl:leading-[60px]"
        >
          {title}
        </h3>
        ...
        <p
          ref={descRef}
          className="text-[14px] md:text-[16px] lg:text-[18px] xl:text-[20px] 2xl:text-[24px] text-[#999999]"
        >
          {description}
        </p>
      </div>
      ...
      <div
        ref={buttonRef}
        className="space-y-4 md:space-y-5 lg:space-y-6 xl:space-y-7 2xl:space-y-[30px]"
      >
        <button
          ...
          <div>
            {isOpen ? (
              <svg
                ...
                className="w-6 h-6 md:w-8 md:h-8 lg:w-10 lg:h-9"
              >
                <path
                  d="M11 19H29"
                  stroke="white"
                  strokeWidth="2"
                  strokeMiterlimit="10"
                  className="md:group-hover:stroke-black"
                />
              </svg>
            ) : (
              <svg
